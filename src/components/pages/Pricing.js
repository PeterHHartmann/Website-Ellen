...
const Pricing = () => {
    return (
        <main className='page'>
            <h1>Henvisning via egen læge</h1>
            <b>Hvem kan henvises?</b>
            <br/>
            ...
            <ol>
                ...
                <li>
                    <p>
                        Unge mellem 18-21 år med behov for samtaler, kan få gratis psykologsamtaler.
                    </p>
                </li>
            </ol>
            <p>
            ...
            <h2>Priser</h2>
            <p>
                Priser for samtaler via den Offentlige Sygesikring stiger hver 1. april og 1. oktober med nogle få kroner. Du kan altid få den aktuelle pris ved at søge på Dansk Psykologforenings hjemmeside:&nbsp;
                <a href='https://www.dp.dk/'>www.dp.dk</a>
                , klik på "Selvstændige" og til højre finder du "Honorarer" og herunder "Praksishonorarer".
            </p>
            ...
            <h2>Honorar ved fuld egenbetaling pr. 1. oktober 2019</h2>
            <ul>
                <li>
                    <div className='custom-li'>
            ...
            <ul>
                <li>
                    <div className='custom-li'>
                        <p>Individuel supervision / coaching (for 60 min)</p>
                        <p><b><u>kr. 1.200,00,-	</u></b></p>
                    </div>
                </li>
                <li>
                    <div className='custom-li'>
                        <p>Gruppesupervision (2-8 deltagere), pr. person</p>
                        <p><b><u>Efter aftale</u></b></p>
                    </div>
                </li>
            </ul>
            ...
            <p>
                <u>Tilskud fra sygesikringen - med henvisning fra læge</u>
                <br/>
            ...
            <p>
                <u>Kommunalt tilskud</u>
                <br/>
                Kommuner kan ud fra en social og økonomisk vurdering i visse tilfælde bevilge såkaldt enkeltydelse til samtaleforløb.
            </p>
            <p>
                <u>Arbejdsskadestyrelsen</u>
                I forbindelse med visse psykiske arbejdsskader kan Arbejdsskadestyrelsen yde tilskud til psykologbehandling.
            </p>
        </main>
    )
}
